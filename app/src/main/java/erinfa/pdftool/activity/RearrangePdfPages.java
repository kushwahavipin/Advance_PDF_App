...
import erinfa.pdftool.adapter.RearrangePdfAdapter;
import erinfa.pdftool.util.Constants;
import erinfa.pdftool.util.DialogUtils;
import erinfa.pdftool.util.ThemeUtils;

import static erinfa.pdftool.util.Constants.CHOICE_REMOVE_IMAGE;
import static erinfa.pdftool.util.Constants.RESULT;
import static erinfa.pdftool.util.Constants.SAME_FILE;
