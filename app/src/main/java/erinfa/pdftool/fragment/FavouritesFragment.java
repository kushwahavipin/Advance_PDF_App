...
import erinfa.pdftool.activity.FavouritesActivity;
import erinfa.pdftool.activity.MainActivity;
import erinfa.pdftool.customviews.MyCardView;
import erinfa.pdftool.fragment.texttopdf.TextToPdfFragment;
import erinfa.pdftool.model.HomePageItem;
import erinfa.pdftool.util.CommonCodeUtils;

import static erinfa.pdftool.util.Constants.ADD_IMAGES;
import static erinfa.pdftool.util.Constants.ADD_IMAGES_KEY;
import static erinfa.pdftool.util.Constants.ADD_PASSWORD_KEY;
import static erinfa.pdftool.util.Constants.ADD_PWD;
import static erinfa.pdftool.util.Constants.ADD_TEXT_KEY;
...
import static erinfa.pdftool.util.Constants.COMPRESS_PDF;
import static erinfa.pdftool.util.Constants.COMPRESS_PDF_KEY;
import static erinfa.pdftool.util.Constants.EXCEL_TO_PDF_KEY;
import static erinfa.pdftool.util.Constants.EXTRACT_IMAGES;
import static erinfa.pdftool.util.Constants.EXTRACT_IMAGES_KEY;
import static erinfa.pdftool.util.Constants.EXTRACT_TEXT_KEY;
import static erinfa.pdftool.util.Constants.HISTORY_KEY;
import static erinfa.pdftool.util.Constants.IMAGE_TO_PDF_KEY;
import static erinfa.pdftool.util.Constants.INVERT_PDF_KEY;
import static erinfa.pdftool.util.Constants.MERGE_PDF_KEY;
import static erinfa.pdftool.util.Constants.PDF_TO_IMAGES;
import static erinfa.pdftool.util.Constants.PDF_TO_IMAGES_KEY;
import static erinfa.pdftool.util.Constants.QR_BARCODE_KEY;
import static erinfa.pdftool.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static erinfa.pdftool.util.Constants.REMOVE_PAGES;
import static erinfa.pdftool.util.Constants.REMOVE_PAGES_KEY;
import static erinfa.pdftool.util.Constants.REMOVE_PASSWORD_KEY;
import static erinfa.pdftool.util.Constants.REMOVE_PWd;
import static erinfa.pdftool.util.Constants.REORDER_PAGES;
import static erinfa.pdftool.util.Constants.REORDER_PAGES_KEY;
import static erinfa.pdftool.util.Constants.ROTATE_PAGES;
import static erinfa.pdftool.util.Constants.ROTATE_PAGES_KEY;
import static erinfa.pdftool.util.Constants.SPLIT_PDF_KEY;
import static erinfa.pdftool.util.Constants.TEXT_TO_PDF_KEY;
import static erinfa.pdftool.util.Constants.VIEW_FILES_KEY;
import static erinfa.pdftool.util.Constants.ZIP_TO_PDF_KEY;
